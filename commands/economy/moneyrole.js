...
**Sending $numberSeparator[$message[1];,]$getServerVar[symbol] to the role $roleName[$findrole[$message[2]]]**
...
$argsCheck[2;{newEmbed: {color:$getVar[color]} {author:Error:https://cdn.discordapp.com/emojis/946761779839631380.webp?size=128&quality=lossless} {description:**Did you mean \`$getServerVar[prefix]moneyrole < amount > < @role_mention >\`**}}]
