...
$description[1;**Added $numberSeparator[$get[amount];,]$getServerVar[symbol] to <@$get[u]>**]
...
$onlyIf[$checkContains[$get[amount];-;+;=;_;.;,;/]==false;{newEmbed: {color:$getVar[color]} {author:Error:https://cdn.discordapp.com/emojis/946761779839631380.webp?size=128&quality=lossless} {description:**That is not a number**}}]

$argsCheck[>0;{newEmbed: {color:$getVar[color]} {author:Error:https://cdn.discordapp.com/emojis/946761779839631380.webp?size=128&quality=lossless} {description:**Did you mean \`$getServerVar[prefix]addmoney < amount > < @user >\`**}}]
