...
You can buy roles with example, \`$getServerVar[prefix]buy < number >\`. Easy right? I know, I know hhh}
$If[$getServerVar[ro1]!=]
...
$endif
$suppressErrors[wrong usage]
$argscheck[>0;{newEmbed: {title:<:D_rightarrow:953778843389399131> **Missing arguments**} {color:$getServerVar[color]} {description: **Usage : \`$tolowercase[$commandname] [page]\`**}}]`}