...
$onlyIf[$message[1]<$getUserVar[req;$findMember[$message[2];yes]];{newEmbed: {color:$getServerVar[color]} {author:An error has occured:https://cdn.discordapp.com/emojis/946761780540112977.webp?size=56&quality=lossless} {description: <:reddx:953987871319162890> **You cant add more xp than their req**}}]
