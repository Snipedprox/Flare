...
$onlyIf[$message[1]!=;{newEmbed: {title:<:D_rightarrow:953778843389399131> **Missing arguments**} {color:$getServerVar[color]} {description: **Usage : \`$tolowercase[$commandname] [index] [@role] [message]\`
Note: index can be from 1 up to 30**}}]

$argsCheck[>2;{newEmbed: {title:<:D_rightarrow:953778843389399131> **Missing arguments**} {color:$getServerVar[color]} {description: **Usage : \`$tolowercase[$commandname] [index] [@role] [message]\`
Note: index can be from 1 up to 30**}}]
