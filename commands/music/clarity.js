...
$replaceText[$setFilter[{"aecho": "1.0:0.7:0.1:0.7"}];[object Object];]


$channelsendMessage[$channelid;{newEmbed: {color:$getServerVar[color]} {author:$replaceText[**Filter applied;*;]:$useravatar[$clientid]} {description:<:TT_love:942521075596656700> **I applied the \`clarity\` filter**}};no]
