...
$replaceText[$setFilter[{"asetrate": "48000*0.8"}];[object Object];]


$channelsendMessage[$channelid;{newEmbed: {color:$getServerVar[color]} {author:$replaceText[**Filter applied;*;]:$useravatar[$clientid]} {description:<:TT_love:942521075596656700> **I applied the \`vaporwave\` filter**}};no]
