...
$replaceText[$setFilter[{"flanger": "1"}];[object Object];]

$channelsendMessage[$channelid;{newEmbed: {color:$getServerVar[color]} {author:$replaceText[**Filter applied;*;]:$useravatar[$clientid]} {description:<:TT_love:942521075596656700> **I applied the \`flanger\` filter**}};no]
