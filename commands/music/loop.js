...
$description[1;<:checkmark:953987845696135188> **Loop set to ( \`$message\` )**]
$loopMode[$toLowerCase[$message]]
...
$argscheck[>1;{newEmbed: {color:$getServerVar[color]} {author:An error has occured:https://cdn.discordapp.com/emojis/946761780540112977.webp?size=56&quality=lossless} {description: <:reddx:953987871319162890> **You need to specify \`song\` , \`queue\` , \`none\`**}}]
