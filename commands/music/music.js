...
$loopMode[song]
$author[1;Loop mode enabled to song;https://images-ext-1.discordapp.net/external/9c9nsxYCtY7jwU6L72ftkelqqeBWB16YG4KdUyzJ8Ro/https/i.imgur.com/8A8MoXV.png]
$color[1;$getServerVar[color]]
$elseIf[$checkCondition[$message[1]==]-$loopStatus$suppressErrors==true-song]
$loopMode[queue]
$author[1;Loop mode enabled to queue;https://images-ext-1.discordapp.net/external/9c9nsxYCtY7jwU6L72ftkelqqeBWB16YG4KdUyzJ8Ro/https/i.imgur.com/8A8MoXV.png]
$color[1;$getServerVar[color]]
$endelseif
$elseIf[$checkCondition[$message[1]==]-$loopStatus$suppressErrors==true-queue]
$author[1;Loop mode disabled;https://images-ext-1.discordapp.net/external/9c9nsxYCtY7jwU6L72ftkelqqeBWB16YG4KdUyzJ8Ro/https/i.imgur.com/8A8MoXV.png]
$color[1;$getServerVar[color]]
$loopMode[none]
$endelseif
$else
